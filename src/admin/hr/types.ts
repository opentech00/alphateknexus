...
export const ACTION_META: Record<string, { label: string; cls: string; icon: string }> = {
  ...
  payslip_issued:  { label: 'Payslip Issued',    cls: 'bg-emerald-50 text-emerald-700 border-emerald-200',  icon: 'emerald' },
  payslip_voided:  { label: 'Payslip Voided',    cls: 'bg-red-50 text-red-600 border-red-200',              icon: 'red' },
};
